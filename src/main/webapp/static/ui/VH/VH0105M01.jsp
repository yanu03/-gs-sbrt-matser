    ...
    <div data-options="region:'north', border:true, minHeight:50, maxHeight:50">
        <div class="easyui-layout" data-options="fit:true">
            ...
            <div data-options="region:'center', border:true">
                ...
                <!-- search js -->
                <script src="/static/js/VH0105/VH0105_sch_searchbox0.js"></script>
                <script src="/static/js/VH0105/VH0105_sch_fromtodate0.js"></script>
                <script src="/static/js/VH0105/VH0105_sch_radio0.js"></script>
            </div>
            </form>
            <div data-options="region:'east', border:true, minWidth:600, maxWidth:600">
                ...
                <!-- btn js -->   
                <script src="/static/js/VH0105/VH0105_btn0.js"></script>
            </div>        
        </div>
    </div>
    <div data-options="region:'center', border:true">  <!--, maxWidth:280, minWidth:280-->
        <div class="easyui-layout" data-options="fit:true">
            <div data-options="region:'center', border:true">
                ...
                <!-- dg0 js -->
                <script src="/static/js/VH0105/VH0105_dg0.js"></script>
            </div>
            <div data-options="region:'east', border:true, maxWidth:600, minWidth:600">
                ...
                <!-- map js -->
                <!-- <script src="/static/js/VH0105/VH0105_map0.js"></script> -->
            </div>
        </div>
    </div>
	</div>	
