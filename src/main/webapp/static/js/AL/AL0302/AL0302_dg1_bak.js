...
$(function(){
	...
	$('#dg1').datagrid({
		...
		columns:[[
					...
					{field:'',title:'오후',width:225,halign:'center',align:'center',colspan:6},
				],
				[
					{field:'OPER_DT',title:'운행일',width:150,halign:'center',align:'center', hidden:true},
					...
					// {field:'VHC_NO',title:'차량번호',width:150,halign:'center',align:'center',editor:{type:'textbox'}},
					...
					,loader:function(param, success, error){$.tracomcbloader($(this), param, success, error)}}}},
					{field:'SEC_TRAN_TM',title:'교대시각',width:100,halign:'center',align:'center'},
				]
			],
