...
$(function(){
	...
	$('#dg1').datagrid({
		url:'http://192.168.34.82:8183/repRout/selectRepRoutListByNode',	//json 조회 url
		method: 'post',
		queryParams: JSON.stringify({dma_sub_search : {CRS_ID : ""}}),						//json 조회 params
		...
		showFooter: true,
    columns:[[
        {field:'REP_ROUT_NM',title:'그룹노선명',width:100,halign:'center',align:'left'},
