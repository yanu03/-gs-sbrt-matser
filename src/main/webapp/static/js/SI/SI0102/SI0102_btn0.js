...
$(function(){
    ...
    $('#btn2').bind('click', function(){
        ...
        $.jf_checkforeigntable($.jf_curdgrow($('#dg0')),"SI0102", function(a_type){
    ...
    $('#btn7').bind('click', function(){
        $.jf_exceldownload($('#dg0'), '/si/SI0102G0_exlDownload?param='+ $('#sch_sb0').searchbox('getValue'));
    });
    ...
    $("#excelinputfile").on("change", function(e){
        ...
        $.jf_excelupload($('#dg0'), formData, '/si/SI0102G0_exlUpload');
    }); 
});