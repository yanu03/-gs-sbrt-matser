...
$(function(){
    ...
    multiSort: true,
    columns:[[
            {field:'COMP_ID',title:'운수사 ID',width:150,align:'left',halign:'center',hidden:true},
            ...
            {field:'AREA_NM',title:'권역명',width:120,align:'left',halign:'center',sortable:true},
            ...
            {field:'MAKER_NM',title:'제조사명',width:100,align:'left',halign:'center',sortable:true},
