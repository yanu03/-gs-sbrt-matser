...
$(function(){
	...
	$('#btn2').bind('click', function(){
		//미완료, 삭제시 데이터검증 필요함
		$.jf_checkforeigntable($.jf_curdgrow($('#dg0')),"SI0503", function(){
			$.jf_delete($('#dg0'));
		}
);
	});
  ...
  $('#btn7').bind('click', function(){
		$.jf_exceldownload($('#dg0'), '/si/SI0503G0_exlDownload?param='+ $('#sch_sb0').searchbox('getValue'));
	});
	...
	$("#excelinputfile").on("change", function(e){
			...
			$.jf_excelupload($('#dg0'), formData, '/si/SI0503G0_exlUpload');
	}); 
});