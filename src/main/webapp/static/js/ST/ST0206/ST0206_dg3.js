...
$(function(){
	//single main grid
	$('#dg_panel3').append('<table id="dg3" style="width:100%;height:100%"></table>');
  ...
  let v_tdate = $.tracombasicdate();
    ...
    $('#dg3').pivotgrid({
        url:'/st/ST0206G1R0',
        method:'POST',
        queryParams: JSON.stringify({dma_search : {DAY_DIV:"", F_DATE:v_fdate, L_DATE:v_tdate, NODE_ID:"",SELECT_DIV:'MONTH'}}),
        pivot:{
            rows:['NODE_NM'],
            columns:['OPER_DT'],
            values:[
        ...
        loader: function(param, success, error){
          let v_chkdata = $('#dg3').pivotgrid('getData');
        ...
        headerStyler: function(title, col){
          ...
          else if(col._field == 'OPER_DT') col.title +='월';
