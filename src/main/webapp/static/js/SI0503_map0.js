...
$(function(){
    ...
    kakao.maps.event.addListener(js_map, 'click', function(a_mouseEvent) {        
        ...
        $.jf_movemarker($.jf_fndmkstrct($.jf_curdgfieldvalue($('#dg0'),'CRS_ID')), v_latlng.getLng(), v_latlng.getLat());
        $.jf_moveoverlay($.jf_fndostrct($.jf_curdgfieldvalue($('#dg0'),'CRS_ID')), v_latlng.getLng(), v_latlng.getLat());
    });
