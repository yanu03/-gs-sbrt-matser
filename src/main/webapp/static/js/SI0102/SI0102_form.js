...
$(function(){
    ...
    $('#fm_panel0').append('<input id="SCV_VHC_CNT" name="SCV_VHC_CNT">&nbsp;&nbsp;');
    $('#fm_panel0').append('<input id="COMP_REG_NO" name="COMP_REG_NO"><p>');
    $('#fm_panel0').append('<input id="SPR_VHC_CNT" name="SPR_VHC_CNT">&nbsp;&nbsp;');
    ...
    $('#AREA').combobox({
		...
		height: 24,
		editable: false,
		url: 'js/SI0102/JSON folder/SI0102_AREA_data.json',
		method: 'get',
		queryParams: {},
		valueField: 'id',
		textField: 'text',
