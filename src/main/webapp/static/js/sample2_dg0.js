$(function(){
    ...
    method: 'POST',
    queryParams: JSON.stringify({"dma_search" : {"CONTENT" : "", "TYPE" : "ALL"}}), //json 조회 params, 초기 param은 직접 입력하도록 함
	singleSelect: true,
	border: false,
	loadMsg: '데이터 로딩중입니다',
	emptyMsg: '데이터가 없습니다',
    ...
    columns:[[
        ...
        {field:'VHC_NO',title:'차량 번호',width:140,align:'center',halign:'center'}
    				]],
		frozenColumns:[[
						]],
