...
$(function(){
	...
	$('#dg0').datagrid({
    url:'http://192.168.34.82:8183/si/SI0501G0R0',	//json 조회 url
    method: 'post',
    ...
    columns:[[
        ...
        {field:'STTN_ENM',title:'정류소영문명',width:250,halign:'center',align:'left'},
        ...
        // {field:'STTN_FCLT_TYPE',title:'정류소시설유형',width:100,halign:'center',align:'center'},
        {field:'STTN_FCLT_TYPE_NM',title:'정류소시설유형',width:100,halign:'center',align:'center'},
		// {field:'VHC_DOOR_DIR_TYPE',title:'버스문방향',width:100,align:'center',halign:'center'},
		{field:'VHC_DOOR_DIR_TYPE_NM',title:'버스문방향',width:100,align:'center',halign:'center'},
		// {field:'WAY_DIV',title:'상하행',width:100,align:'center',halign:'center'},
		{field:'WAY_DIV_NM',title:'상하행',width:100,align:'center',halign:'center'},
		// {field:'BAY_TYPE',title:'베이유형',width:100,align:'center',halign:'center',},
		...
		onSelect: function(index,row){
			...
			$.jf_childretrieve($('#dg1'), $.pf_childparams($('#dg1'), row), 'dma_sub_search');
		},
