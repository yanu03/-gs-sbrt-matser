...
//maxlength 추가하였음 - 0331 양현우
if(typeof(_5c0.options.maxlength) != "undefined") $("<input id=\""+_5c1+"\" type=\""+opts.type+"\" maxlength="+_5c0.options.maxlength+" class=\"textbox-text\" autocomplete=\"off\">").prependTo(tb);
else $("<input id=\""+_5c1+"\" type=\""+opts.type+"\" class=\"textbox-text\" autocomplete=\"off\">").prependTo(tb);
}
