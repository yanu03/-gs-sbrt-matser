...
public class ServiceSupport extends EgovAbstractServiceImpl {
	...
	protected Map<String, Object> getSimpleDataMap(String key, boolean isEncodeXSS) throws Exception
	{
		...
		Map<String, Object> map = (Map<String, Object>)((Map<?, ?>) obj).get(key);
		if (map == null)
		{
			map = (Map<String, Object>)((Map<?, ?>) obj).get("dma_search");
			if (map == null) {
	...
	protected String getDataString(String key) throws Exception
	{
		String rtnStr;
		rtnStr = (String)request.getParameter(key);
		return rtnStr;
	}
	
	protected String getParamString() throws Exception
	{
		...
		while(paramNames.hasMoreElements()){
	        	...
	        	i++;
		        rtnStr += paramName+"=" + request.getParameter(paramName);
		}
		return rtnStr;
	}
}
