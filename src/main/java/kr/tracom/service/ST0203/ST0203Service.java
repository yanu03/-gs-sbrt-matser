package kr.tracom.service.ST0203;
...
import kr.tracom.mapper.ST0203.ST0203Mapper;
import kr.tracom.support.ServiceSupport;

@Service
public class ST0203Service extends ServiceSupport {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ServiceSupport.class);

	@Autowired
	private ST0203Mapper st0203Mapper;
	
	public List ST0203G0R0() throws Exception {
		Map<String, Object> map = getSimpleDataMap("dma_search");
		return st0203Mapper.ST0203G0R0(map);
	}
	
	public List ST0203G1R0() throws Exception {
		Map<String, Object> map = getSimpleDataMap("dma_sub_search");
		return st0203Mapper.ST0203G1R0(map);
	}
	/*
