package kr.tracom.service.AL0104;
...
import kr.tracom.mapper.AL0104.AL0104Mapper;
...
public class AL0104Service extends ServiceSupport{
	...
	public List AL0104G0R0() throws Exception {
		Map<String, Object> map = getSimpleDataMap("dma_search");
		List list = al0104Mapper.AL0104G0R0(map);	 
		 return list;
	}
	...
	public Map AL0104G2S0() throws Exception {
		...
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_ROUT_GRP_VHC_CMPSTN");
