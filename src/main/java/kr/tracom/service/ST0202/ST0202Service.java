package kr.tracom.service.ST0202;
...
import kr.tracom.mapper.ST0202.ST0202Mapper;
import kr.tracom.support.ServiceSupport;

@Service
public class ST0202Service extends ServiceSupport {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ServiceSupport.class);

	@Autowired
	private ST0202Mapper st0202Mapper;
