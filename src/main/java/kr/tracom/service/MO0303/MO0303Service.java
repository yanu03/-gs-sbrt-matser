package kr.tracom.service.MO0303;
...
import kr.tracom.mapper.MO0303.MO0303Mapper;
...
public class MO0303Service extends ServiceSupport {
	...
	public Map MO0303G0S0() throws Exception {
		...
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_INCDNT_INFO");
		try {
	...
	public Map MO0303G1S0() throws Exception {
		...
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_INCDNT_RES_INFO");
		try {
			for (int i = 0; i < param.size(); i++) {
				Map data = (Map) param.get(i);
				String rowStatus = (String) data.get("rowStatus");
