package kr.tracom.service.MO0500;
...
import kr.tracom.mapper.MO0500.MO0500Mapper;
...
public class MO0500Service extends ServiceSupport{
	...
	public Map MO0500G0S0() throws Exception {
		...
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_OPER_APPR_INFO");
		try {
	...
	public Map MO0500P0S0() throws Exception {
		...
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_CPLNT_HIS");
