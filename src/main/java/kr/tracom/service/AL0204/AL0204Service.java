package kr.tracom.service.AL0204;
...
import kr.tracom.mapper.AL0204.AL0204Mapper;
...
public class AL0204Service extends ServiceSupport {
	...
	public Map AL0204G1S0() throws Exception {
		...
		int uCnt = 0;
		int dCnt = 0;
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_DAY_OPER_ALLOC_PL_NODE_INFO");
		try {
