package kr.tracom.service.AL0103;
...
import kr.tracom.mapper.AL0103.AL0103Mapper;
...
public class AL0103Service extends ServiceSupport {
	...
	public Map AL0103G0S0() throws Exception {
		...
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_COR_MST");
		try {
	...
	public Map AL0103G1S0() throws Exception {
		...
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_COR_DTL_INFO");
		try {
			for (int i = 0; i < param.size(); i++) {
				Map data = (Map) param.get(i);
				String rowStatus = (String) data.get("rowStatus");
