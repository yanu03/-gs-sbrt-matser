package kr.tracom.service.AL0303;
...
import kr.tracom.mapper.AL0303.AL0303Mapper;
...
public class AL0303Service extends ServiceSupport{
	...
	public Map AL0303G0S0() throws Exception {
		...
		List<Map<String, Object>> param = getSimpleList("dlt_BMS_RPC_VHC_INFO");
		try {
			for (int i = 0; i < param.size(); i++) {
				...
				if(rowStatus.equals("C")) {
					iCnt += AL0303Mapper.AL0303G0I0(data);
	                  ...
	                  //String actionData = (String) data.get("ROUT_GRP")+","+data.get("OPER_DT")+","+data.get("ALLOC_NO")+","+
	                   ...
	                   brtRequest.setReserved(actionData);
	                     ...
	                     //BMS_CUR_ALLOC_PL_INFO 운행 차량아이디 변경
