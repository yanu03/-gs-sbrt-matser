package kr.tracom.mapper.cm.OperPlan;
...
public interface OperPlanMapper {
    ...
    //노선의 첨두시 가져오기
	public Map<String, Object> selectRoutPeakTm(Map<String, Object> params);
	
	//배차의 첨두시 가져오기
	public Map<String, Object> selectAllocPeakTm(Map<String, Object> params);
    //대표노선 가져오기
