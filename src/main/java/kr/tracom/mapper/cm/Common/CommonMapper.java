package kr.tracom.mapper.cm.Common;
...
public interface CommonMapper {
	...
	public List<HashMap<String, Object>> selectMenuListByLevel(Map param);
	
	public List<HashMap<String, Object>> selectAllMenuList(Map param);
	
	public List<HashMap<String, Object>> selectAllMenuListByLevel(Map param);
